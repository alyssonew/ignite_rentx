...
rentalRoutes.post("/devolution/:id", ensureAuthenticated, devolutionRentalConroller.handle)
rentalRoutes.get("/user", ensureAuthenticated, listRentalsByUserController.hanle)
export { rentalRoutes}